      ...
      <View style={[
        ...
        <ScrollView
          ...
          {this.props.dataSource.map((image, index) => {
            const imageObject = typeof image.accessUrl === 'string' ? {uri: image.accessUrl} : image.accessUrl;
            const textComponent = (
...
Slideshow.propTypes = {
	dataSource: PropTypes.arrayOf(PropTypes.shape({
	    ...
	    accessUrl: PropTypes.oneOfType([PropTypes.string, PropTypes.number]).isRequired,
    })).isRequired, 
